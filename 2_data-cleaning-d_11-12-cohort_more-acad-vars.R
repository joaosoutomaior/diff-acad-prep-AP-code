...
load(paste0(DOE_server_wd_data,"/dataset_3_cohort-11-12.Rdata"))
...
#=========== 2012
dat_nyc <- read_sas(DOE_dataset_HScredits_12, 
...
#=========== 2010
dat_nyc <- read_sas(DOE_dataset_MScredits_10, 
                    cols_only = c("RANYCSID", 
                                   "CREDATMTOT", #total credits attempted
                                   "CRSCFALTOT", #total credits failed
                                   "CRSCPASTOT",
...
dat_nyc <- read_sas(DOE_dataset_MSstateexams_10, 
                    cols_only = c("RANYCSID", 
                                  #MTH 
                                  "MTHGRD",# test grade
                                  "MTHPCTCAL", # percentile, calculated score
...
#=========== 2010
dat_nyc <- read_sas(DOE_dataset_susp_10, 
                    cols_only = c("RANYCSID", 
...
dat_nyc <- read_sas(DOE_dataset_susp_11, 
                    cols_only = c("RANYCSID", 
                                   ...
                                   "SUSTOTDAYS", 
                                   "SUSINFTOT",
                                   "SUSINFTOTELM" # total elementary infractions
                    ))
...
# Save data
#==============================================================
save(dat, file = paste0(DOE_server_wd_data,"/dataset_4_cohort-11-12.Rdata"))
