...
#      high school trajectory up until their senior year
...
sink("output/student-level-filter_cohort-12-13.txt")
#=============================================================
# 7th grade
#=============================================================
...
# Senior year 2
#=============================================================
dat_nyc <- read_sas(DOE_dataset_enr_17, 
                    cols_only = c("RANYCSID", 
                                   "DOEGLVOCT", # student grade oct. e.g: "12"
                                   "AGDDCATOCT",
                                   "DBNOCT"))
...
# Save NYC file 
#============================================================== 
save(dat, file = paste0(DOE_server_wd_data,"/dataset_7_cohort-12-13.Rdata"))
save(dat_ret, file = paste0(DOE_server_wd_data,"/dataset_7_cohort-12-13_anti.Rdata"))