...
load(paste0(DOE_server_wd_data,"/dataset_2_cohort-12-13.Rdata"))
...
dat_nyc <- read_sas(DOE_dataset_courses_16,
...
length(unique(dat_nyc_s$RANYCSID_13))
length(unique(dat_nyc_t$RANYCSID_13))
length(unique(dat$RANYCSID_13))
nrow(dat)
ncol(dat)
...
# Save data
#==============================================================
save(dat, file = paste0(DOE_server_wd_data,"/dataset_3_cohort-12-13.Rdata"))
