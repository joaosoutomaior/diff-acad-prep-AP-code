...
#=============================================================
# All Seniors year (2016)
#=============================================================
dat_g12 <- read_sas(DOE_dataset_enr_16, 
...
dat_ap <- read_sas(DOE_dataset_courses_16,
...
dat_exams <- read_sas(DOE_dataset_exams_16)
...
save(dat_g12, file = paste0(DOE_server_wd_data,"/dataset_check_all-g12-2015-16.Rdata"))

#=============================================================
# All juniors year (2015)
#=============================================================
dat_g11 <- read_sas(DOE_dataset_enr_15, 
                    cols_only = c("RANYCSID", 
...
save(dat_g11, file = paste0(DOE_server_wd_data,"/dataset_check_all-g11-2014-15.Rdata"))

#=============================================================
# All sophomores year (2014)
#=============================================================
dat_g10 <- read_sas(DOE_dataset_enr_14, 
                    cols_only = c("RANYCSID", 
...
save(dat_g10, file = paste0(DOE_server_wd_data,"/dataset_check_all-g10-2013-14.Rdata"))

#=============================================================
# All freshman year (2013)
#=============================================================
dat_g09 <- read_sas(DOE_dataset_enr_13, 
                    cols_only = c("RANYCSID", 
...
#============ Merge course data with original data
# Var names
colnames(dat_ap_c) <- paste(colnames(dat_ap_c), "13", sep = "_")
colnames(dat_ap_s) <- paste(colnames(dat_ap_s), "13", sep = "_")
colnames(dat_ap_t) <- paste(colnames(dat_ap_t), "13", sep = "_")

# check intersection
x <- intersect(dat_g09$RANYCSID, dat_ap_c$RANYCSID_13) 
length(x)
x <- intersect(dat_g09$RANYCSID, dat_ap_s$RANYCSID_13) 
length(x)
x <- intersect(dat_g09$RANYCSID, dat_ap_t$RANYCSID_13) 
length(x)

# merge data
dat_g09 <- left_join(dat_g09, dat_ap_c, by = c("RANYCSID" = "RANYCSID_13"))
dat_g09 <- left_join(dat_g09, dat_ap_s, by = c("RANYCSID" = "RANYCSID_13"))
dat_g09 <- left_join(dat_g09, dat_ap_t, by = c("RANYCSID" = "RANYCSID_13"))

#============ Check and adjust aggregated variables
# Check
length(unique(dat_ap_c$RANYCSID_13))
length(unique(dat_ap_s$RANYCSID_13))
length(unique(dat_ap_t$RANYCSID_13))
length(unique(dat_g09$RANYCSID))
nrow(dat_g09)
ncol(dat_g09)
...
save(dat_g09, file = paste0(DOE_server_wd_data,"/dataset_check_all-g09-2012-13.Rdata"))