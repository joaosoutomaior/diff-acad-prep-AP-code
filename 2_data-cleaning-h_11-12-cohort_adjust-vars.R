...
load(paste0(DOE_server_wd_data,"/dataset_7_cohort-11-12.Rdata"))

# print to visualize missing
#sink("output/missing-11-12.txt")
#=============================================================
# Missing data
#=============================================================
...
#==============================================================
# Delete variables which have not been renamed
#==============================================================
...
# to end printed results
#sink()

#==============================================================
# Save
#==============================================================
save(dat, file = paste0(DOE_server_wd_data,"/dataset_8_cohort-11-12.Rdata"))
